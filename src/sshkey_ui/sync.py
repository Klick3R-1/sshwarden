"""sshkey-sync — replaces bw-ssh-pubsync.
...
def run_sync(session: str, *, clean: bool = False) -> Generator[str, None, None]:
    ...
    auto_content = (
        f"# Auto-generated by sshkey-sync — DO NOT EDIT.\n"
...
def main() -> None:
    ...
    if not session or not is_unlocked(session):
        print("Error: Bitwarden vault is locked. Unlock via the sshkey-ui web interface.", file=sys.stderr)
        sys.exit(1)
